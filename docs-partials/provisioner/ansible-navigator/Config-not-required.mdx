...
- `connection_mode` (string) - ConnectionMode determines how Ansible connects to the target machine.
...
- `bastion` (\*BastionConfig) - Bastion configuration for SSH tunnel mode.
...
- `bastion_password` (string) - DEPRECATED: Use bastion.password instead.
