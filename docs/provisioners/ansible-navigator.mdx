...
provisioner "ansible-navigator" {
  ...
  extra_arguments = [
    ...
    "--extra-vars", "enable_firewall=true"
  ]
}
```
...
provisioner "ansible-navigator" {
  plays = [
    ...
    "integration.portainer.verify_deployment"
  ]
...
provisioner "ansible-navigator" {
  ...
  extra_arguments = [
    "--extra-vars", "hardening_level=high",
...
provisioner "ansible-navigator" {
  ...
  plays = [
    ...
    "baseline.logging.configure_rsyslog",
    "app.webapp.deploy",
    "app.webapp.configure_ssl"
  ]
...
provisioner "ansible-navigator" {
  ...
  extra_arguments = [
    "--extra-vars", "compose_file=/opt/app/docker-compose.yml",
    "--extra-vars", "network_name=app_network",
    "--extra-vars", "container_state=started"
  ]
