...
The remote provisioner's `navigator_config` field SHALL accept arbitrary nested map structures to support the full ansible-navigator.yml configuration schema.
