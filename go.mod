...
// Incorrect plugin registration for ansible-navigator-local; see github.com/solomonhd/packer-plugin-ansible-navigator
// These versions were inherited from the original packer-plugin-ansible fork and should not be used.
retract [v0.0.1, v0.0.2]

replace github.com/zclconf/go-cty => github.com/nywilken/go-cty v1.13.3 // added by packer-sdc fix
...
// as noted in github.com/hashicorp/packer-plugin-sdk/issues/187
